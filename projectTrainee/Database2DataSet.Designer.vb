...
Partial Public Class Database2DataSet
    ...
    Partial Public Class TableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddTableRow(ByVal FirstName As String, ByVal LastName As String, ByVal Gender As String, ByVal Address As String, ByVal Nationality As String, ByVal Email As String, ByVal PhoneNumber As String, ByVal Notes As String) As TableRow
            Dim rowTableRow As TableRow = CType(Me.NewRow,TableRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, FirstName, LastName, Gender, Address, Nationality, Email, PhoneNumber, Notes}
    ...
    Partial Public Class TableRow
        ...
        Public Property Nationality() As String
            Get
                Return CType(Me(Me.tableTable.NationalityColumn),String)
            End Get
            Set
                Me(Me.tableTable.NationalityColumn) = value
            End Set
        End Property
        ...
        Public Property PhoneNumber() As String
            Get
                Return CType(Me(Me.tableTable.PhoneNumberColumn),String)
            End Get
            Set
                Me(Me.tableTable.PhoneNumberColumn) = value
            End Set
        End Property
...
Namespace Database2DataSetTableAdapters
    ...
    Partial Public Class TableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Gender] = @Original_"& _ 
                "Gender) AND ([Address] = @Original_Address) AND ([Nationality] = @Original_Natio"& _ 
                "nality) AND ([Email] = @Original_Email) AND ([PhoneNumber] = @Original_PhoneNumb"& _ 
                "er))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([FirstName], [LastName], [Gender], [Address], [Nationa"& _ 
                "lity], [Email], [PhoneNumber], [Notes]) VALUES (@FirstName, @LastName, @Gender, "& _ 
                "@Address, @Nationality, @Email, @PhoneNumber, @Notes);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, FirstName, La"& _ 
                "stName, Gender, Address, Nationality, Email, PhoneNumber, Notes FROM [Table] WHE"& _ 
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@LastName", Global.System.Data.SqlDbType.Text, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "LastName", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [FirstName] = @FirstName, [LastName] = @LastName, [Gende"& _ 
                "r] = @Gender, [Address] = @Address, [Nationality] = @Nationality, [Email] = @Ema"& _ 
                "il, [PhoneNumber] = @PhoneNumber, [Notes] = @Notes WHERE (([Id] = @Original_Id) "& _ 
                "AND ([Gender] = @Original_Gender) AND ([Address] = @Original_Address) AND ([Nati"& _ 
                "onality] = @Original_Nationality) AND ([Email] = @Original_Email) AND ([PhoneNum"& _ 
                "ber] = @Original_PhoneNumber));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, FirstName, LastName, Gender, Address"& _ 
                ", Nationality, Email, PhoneNumber, Notes FROM [Table] WHERE (Id = @Id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.projectTrainee.My.MySettings.Default.Database2ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, FirstName, LastName, Gender, Address, Nationality, Email, PhoneNumber,"& _ 
                " Notes FROM dbo.[Table]"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database2DataSet.TableDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database2DataSet.TableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database2DataSet.TableDataTable = New Database2DataSet.TableDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database2DataSet.TableDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_Gender As String, ByVal Original_Address As String, ByVal Original_Nationality As String, ByVal Original_Email As String, ByVal Original_PhoneNumber As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal FirstName As String, ByVal LastName As String, ByVal Gender As String, ByVal Address As String, ByVal Nationality As String, ByVal Email As String, ByVal PhoneNumber As String, ByVal Notes As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal FirstName As String, ByVal LastName As String, ByVal Gender As String, ByVal Address As String, ByVal Nationality As String, ByVal Email As String, ByVal PhoneNumber As String, ByVal Notes As String, ByVal Original_Id As Integer, ByVal Original_Gender As String, ByVal Original_Address As String, ByVal Original_Nationality As String, ByVal Original_Email As String, ByVal Original_PhoneNumber As String, ByVal Id As Integer) As Integer
            If (FirstName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("FirstName")
            Else
            ...
            If (Original_Nationality Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Nationality")
            Else
                Me.Adapter.UpdateCommand.Parameters(11).Value = CType(Original_Nationality,String)
            End If
            If (Original_Email Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Email")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal FirstName As String, ByVal LastName As String, ByVal Gender As String, ByVal Address As String, ByVal Nationality As String, ByVal Email As String, ByVal PhoneNumber As String, ByVal Notes As String, ByVal Original_Id As Integer, ByVal Original_Gender As String, ByVal Original_Address As String, ByVal Original_Nationality As String, ByVal Original_Email As String, ByVal Original_PhoneNumber As String) As Integer
            Return Me.Update(FirstName, LastName, Gender, Address, Nationality, Email, PhoneNumber, Notes, Original_Id, Original_Gender, Original_Address, Original_Nationality, Original_Email, Original_PhoneNumber, Original_Id)
        End Function
    End Class
